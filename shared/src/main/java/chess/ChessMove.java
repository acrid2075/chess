...
public class ChessMove {
    ...
    public ChessMove(String moveDetails) {
        this.startPosition = new ChessPosition((int) moveDetails.charAt(1) - (int) '0', "abcdefgh".indexOf(moveDetails.charAt(0)) + 1);
        this.endPosition = new ChessPosition((int) moveDetails.charAt(3) - (int) '0', "abcdefgh".indexOf(moveDetails.charAt(2)) + 1);
